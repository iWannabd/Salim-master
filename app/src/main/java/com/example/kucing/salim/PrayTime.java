package com.example.kucing.salim;//--------------------- Copyright Block ----------------------
/* 
...
public class PrayTime {
    ...
    private double[] tuneTimes(double[] times) {
     ...
     public static ArrayList<String> getFiveTimes(double lon, double lat, Date date) {
         double latitude = lat;
    ...
    public static ArrayList<String> getFiveNames(){
        PrayTime ret = new PrayTime();
        ArrayList<String> namaso = new ArrayList<>();
        namaso.add("Subuh");
        namaso.add("Dzuhr");
        namaso.add("Ashar");
        namaso.add("Maghrib");
